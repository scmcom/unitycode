...
//	public bool showXTangents;
//	public bool showZTangents;
//	public bool showCrossProductNormals;
...
//				sample *= strength;
				...
				if(analyticalDerivatives)
				{
					normals[v] = new Vector3(
						-sample.derivative.x, 1f, -sample.derivative.y).normalized;
				}
...
//		normals = mesh.normals;
	...
	private void CalculateNormals()
	{
		for(int v=0,z=0; z<=resolution; z++)
		{
			...
			{
				normals[v] = new Vector3(
					(-1f*GetXDerivative(x,z)), 1f, (-1f*GetZDerivative(x,z))).normalized;
			}
		}
//		for(int v=0,z=0; z<=resolution; z++)
//		{
...
//				} 
//				else if(showZTangents)
//				{
//					normals[v] = new Vector3(0f, GetZDerivative(x,z), 1f);
//				} 
//				else if(showCrossProductNormals)
//				{
